...
function EditPage() {
	...
	const handleSaveHotspot = () => {
		...
		const updatedHotspot = {
			// Prefer storing the Sketchfab UID (stable identifier) when present;
			modelId: modelUrl?.sketchfabUid
				? modelUrl.sketchfabUid
				: extractArchiveId(modelUrl?.glb || modelUrl?.gltf || defaultModel.glb),
			title,
			description,
	...
	return (
		...
		<div
			className="flex justify-center items-start flex-col flex-col-reverse md:flex-row w-full relative"
