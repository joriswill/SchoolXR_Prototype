...
function HomePage() {
	...
	return (
		<div className="flex flex-col items-center mt-16">
			<h1 className="mb-8" style={{ fontSize: "50px" }}>
				Willkommen!
			</h1>
			...
			<div className="fixed bottom-6 right-6 z-50 flex gap-4">
				...
				<button
					className={`bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg w-16 h-16 flex items-center justify-center text-3xl`}
